...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:n,host:a})=>{const[r,l]=(0,s.useState)(!1),[d,m]=(0,s.useState)(!1),[p,_]=(0,s.useState)(void 0),y=(0,i.cx)("editor"===a?x:v),k=g[n],w=(0,i.cx)(b);return s.default.createElement("div",{className:y,onMouseEnter:()=>{m(!0)},onMouseLeave:()=>{m(!1)}},s.default.createElement(c.Prism,{language:t,style:k,wrapLongLines:o,showLineNumbers:"editor"===a},e),s.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(p)||(clearTimeout(p),_(void 0)),l(t),_(setTimeout((()=>{l(!1)}),2e3))}},s.default.createElement("button",{className:w,style:{opacity:d?1:0}},r?s.default.createElement(h.HiCheck,null):s.default.createElement(h.HiClipboard,null))))}},66999:function(e,t,o){var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const a=o(18592),r=n(o(67294)),l=o(19446),i=a.css`
