...
`,c=a.css`
  label: vertical;
  flex-direction: row;
`;t.AppContainer=({children:e,direction:t,className:n})=>{const o=(0,a.cx)(i,"horizontal"===t?c:l,n);return r.default.createElement("div",{className:o},e)}},79514:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Button=void 0;const a=n(18592),r=o(n(67294)),s=n(61329),i=a.css`
...
`;t.Button=({children:e,variant:t,className:n})=>{const o=(0,a.cx)(c,"primary"===t?l:i,n);return r.default.createElement("button",{className:o},e)}},4151:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Content=void 0;const a=o(n(67294)),r=n(18592),s=n(158),i=r.css`
  label: content;
  width: 100%;
  flex: 1 1 1px;
  margin: 0px;
  ...
  display: flex;
  flex-direction: column;
`;t.Content=({children:e})=>a.default.createElement("main",{className:(0,r.cx)(i,s.ctnr)},e)},55050:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Footer=void 0;const a=n(18592),r=o(n(67294)),s=n(15435),i=n(61329),l=n(86299),c=a.css`
  label: footer;
...
`,m=a.css`
  ...
  color: ${i.theme.colors.muted};
`;t.Footer=()=>r.default.createElement("footer",{className:c},r.default.createElement("a",{className:u,href:"#"},r.default.createElement(s.Logo,{width:60,color:i.theme.colors.muted}),r.default.createElement("h1",{className:m},"Oats")),r.default.createElement("span",{className:d},"Copyright © 2022 Balázs Édes"),r.default.createElement("span",{className:p},"All Oats modules under the ",r.default.createElement(l.Link,{href:"https://opensource.org/licenses/MIT"},"MIT license")))},73976:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Header=void 0;const a=n(18592),r=o(n(67294)),s=n(69274),i=n(61329),l=n(158),c=n(20012),d=n(16045),p=a.css`
  label: header;
  width: 100%;
  margin: 0px;
  padding: 0px;
...
`;t.Header=()=>r.default.createElement("header",{className:p},r.default.createElement("div",{className:(0,a.cx)(u,l.ctnr)},r.default.createElement(d.MenuLogo,null),r.default.createElement("ul",{className:m},r.default.createElement(c.MenuItem,{label:"Home",icon:s.HiHome,href:"#/",active:!0}),r.default.createElement(c.MenuItem,{label:"Documentation",icon:s.HiDocument,href:"#/documentation"}),r.default.createElement(c.MenuItem,{label:"Configuration Editor",icon:s.HiCog6Tooth,href:"#/"}))))},20364:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Headlines=void 0;const a=n(18592),r=o(n(67294)),s=n(69274),i=n(61329),l=n(79514),c=n(158),d=a.css`
  label: headlines;
  display: flex;
  flex-direction: row;
  gap: 24px;
...
`,m=a.css`
  ...
  margin-bottom: 24px;
  flex: 1 1 1px;
`;t.Headlines=()=>r.default.createElement("div",{className:d},r.default.createElement("div",{className:p},r.default.createElement("h3",{className:u},r.default.createElement(s.HiPuzzlePiece,null),"Generate an SDK"),r.default.createElement("section",{className:m},"Create an easy to use, statically typed SDK for your backend, with all the bells and whistles, and either use it in house, or expose it to your customers."),r.default.createElement(l.Button,null,r.default.createElement(s.HiBookOpen,null),"Learn more")),r.default.createElement("div",{className:p},r.default.createElement("h3",{className:u},r.default.createElement(s.HiServerStack,null),"Generate the backend"),r.default.createElement("section",{className:m},"Generate all the tedious parts of your backend, like routing, parameter and body parsing and serialization, and CORS, and just implement moving data."),r.default.createElement(l.Button,null,r.default.createElement(s.HiBookOpen,null),"Learn more")),r.default.createElement("div",{className:p},r.default.createElement("h3",{className:u},r.default.createElement(s.HiWrenchScrewdriver,null),"Customize generators"),r.default.createElement("section",{className:m},"The available generators don't fully suit your needs, or you need more? Customize existing generators, or create your own, without writing everything from scratch."),r.default.createElement(l.Button,null,r.default.createElement(s.HiBookOpen,null),"Learn more")))},48732:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.HeroSection=void 0;const a=n(18592),r=o(n(67294)),s=n(61329),i=n(79514),l=n(158),c=n(66653),d=n(69274),p=n(86299),u=a.css`
  label: hero-section;
  width: 100%;
  margin: 0px;
  padding: 80px 0px;
...
`,g=a.css`
  ...
  display: flex;
  gap: 12px;
`;t.HeroSection=()=>r.default.createElement("div",{className:u},r.default.createElement("div",{className:(0,a.cx)(l.ctnr,m)},r.default.createElement("h2",{className:h},"Generate TypeScript from OpenAPI, that makes sense."),r.default.createElement("h3",{className:f},"Customizable, extensible and ",r.default.createElement("b",null,"open source")," code generators, that output quality"," ",r.default.createElement(p.Link,{href:"https://www.typescriptlang.org"},"TypeScript"),", from your"," ",r.default.createElement(p.Link,{href:"https://www.openapis.org"},"OpenAPI")," definitions."),r.default.createElement("div",{className:g},r.default.createElement(i.Button,{variant:"primary"},r.default.createElement(d.HiPlay,null)," Get Started"),r.default.createElement(i.Button,null,r.default.createElement(d.HiCog6Tooth,null)," Try Editor"),r.default.createElement(i.Button,null,r.default.createElement(c.GoOctoface,null)," Github"))))},86299:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Link=void 0;const a=o(n(67294)),r=n(18592),s=n(61329),i=r.css`
  label: link;
  position: relative;
  text-decoration: none;
  gap: 8px;
...
`,c=a.css`
  ...
  gap: 8px;
  align-items: center;
`;t.MenuItem=({label:e,active:t,href:n,icon:o})=>{const s=(0,a.cx)(l,t?i:void 0);return r.default.createElement("li",{className:c},r.default.createElement("a",{href:n,className:s},r.default.createElement(o,{size:"20px"}),r.default.createElement("span",null,e)))}},16045:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MenuLogo=void 0;const a=n(18592),r=o(n(67294)),s=n(15435),i=n(61329),l=a.css`
  label: menu-logo;
  display: flex;
  gap: 8px;
  align-items: center;
...
`,c=a.css`
  ...
  font-size: ${i.theme.font.l};
  color: ${i.theme.colors.text};
`;t.MenuLogo=()=>r.default.createElement("a",{className:l,href:"#"},r.default.createElement(s.Logo,{width:60}),r.default.createElement("h1",{className:c},"Oats"))},56005:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.QuickStart=void 0;const a=n(18592),r=o(n(67294)),s=n(60155),i=n(61329),l=n(43418),c=n(7807),d=n(86299),p=o(n(91482)),u=a.css`
  label: quick-start;
  margin-bottom: 40px;
`,m=a.css`
...
`,c=a.css`
  ...
  margin-top: 12px;
  border-radius: 50%;
  border: 1px solid ${s.theme.colors.text};
  color: ${s.theme.colors.text};
  display: flex;
  align-items: center;
  justify-content: center;
...
`,u=a.css`
  ...
  width: 100%;
`;t.QuickStartItem=({children:e,index:t,title:n})=>r.default.createElement("div",{className:l},r.default.createElement("div",{className:c},t),r.default.createElement("div",{className:u},r.default.createElement("h3",{className:d},n),r.default.createElement("div",{className:p},e)))},7807:function(e,t,n){var o=this&&this.__createBinding||(Object.create?function(e,t,n,o){void 0===o&&(o=n);var a=Object.getOwnPropertyDescriptor(t,n);a&&!("get"in a?!t.__esModule:a.writable||a.configurable)||(a={enumerable:!0,get:function(){return t[n]}}),Object.defineProperty(e,o,a)}:function(e,t,n,o){void 0===o&&(o=n),e[o]=t[n]}),a=this&&this.__setModuleDefault||(Object.create?function(e,t){Object.defineProperty(e,"default",{enumerable:!0,value:t})}:function(e,t){e.default=t}),r=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)"default"!==n&&Object.prototype.hasOwnProperty.call(e,n)&&o(t,e,n);return a(t,e),t};Object.defineProperty(t,"__esModule",{value:!0}),t.SyntaxHighlighter=void 0;const s=n(18592),i=r(n(67294)),l=n(67361),c=r(n(29012)),d=n(74855),p=n(61329),u=n(69274),m=n(96486),h=function(e){const t={'pre[class*="language-"]':{backgroundColor:p.theme.colors.dark1,borderRadius:"10px",padding:"18px",width:"100%",maxWidth:"100%",borderWidth:"0px"}},n=(0,m.cloneDeep)(e);return(0,m.values)(n).forEach((e=>{delete e.background,delete e.backgroundColor,e.textShadow="rgb(0 0 0 / 30%) 0px 1px"})),(0,m.merge)(n,t)}(c.vscDarkPlus),f=s.css`
...
`;t.SyntaxHighlighter=({children:e,language:t})=>{const[n,o]=(0,i.useState)(!1),[a,r]=(0,i.useState)(!1),[s,c]=(0,i.useState)(void 0);return i.default.createElement("div",{className:g,onMouseEnter:()=>{r(!0)},onMouseLeave:()=>{r(!1)}},i.default.createElement(l.Prism,{language:t,style:h,wrapLongLines:!0},e),i.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,m.isNil)(s)||(clearTimeout(s),c(void 0)),o(t),c(setTimeout((()=>{o(!1)}),2e3))}},i.default.createElement("button",{className:f,style:{opacity:a?1:0}},n?i.default.createElement(u.HiCheck,null):i.default.createElement(u.HiClipboard,null))))}},86753:(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.getSizeWithAspectRatio=void 0,t.getSizeWithAspectRatio=function(e,t,n,o){return void 0!==n&&void 0===o?[n,t/e*n]:void 0!==o&&void 0===n?[o,e/t*o]:void 0!==n&&void 0!==o?[n,o]:[e,t]}},158:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.ctnr=t.breakpoints=void 0;const o=n(18592);t.breakpoints={desktop:"@media (min-width: 1201px)",tablet:"@media (min-width: 651px) and (max-width: 1200px) ",phone:"@media (max-width: 650px) "},t.ctnr=o.css`
  label: container;
  display: flex;
...
`},12299:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const a=n(26729),r=o(n(67294)),s=n(20745),i=n(49818),l=n(78135),c=n(72050);(0,s.createRoot)(document.getElementById("root")).render(r.default.createElement(i.HashRouter,null,r.default.createElement(a.Global,{styles:c.globalStyles}),r.default.createElement(l.AppV2,null)))},95462:function(e,t,n){var o=this&&this.__createBinding||(Object.create?function(e,t,n,o){void 0===o&&(o=n);var a=Object.getOwnPropertyDescriptor(t,n);a&&!("get"in a?!t.__esModule:a.writable||a.configurable)||(a={enumerable:!0,get:function(){return t[n]}}),Object.defineProperty(e,o,a)}:function(e,t,n,o){void 0===o&&(o=n),e[o]=t[n]}),a=this&&this.__setModuleDefault||(Object.create?function(e,t){Object.defineProperty(e,"default",{enumerable:!0,value:t})}:function(e,t){e.default=t}),r=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)"default"!==n&&Object.prototype.hasOwnProperty.call(e,n)&&o(t,e,n);return a(t,e),t};Object.defineProperty(t,"__esModule",{value:!0}),t.DocumentationPage=void 0;const s=n(18592),i=n(67535),l=r(n(67294)),c=n(69274),d=n(49818),p=n(12872),u=n(15435),m=n(76197),h=n(61329),f=n(21704),g=s.css`
...
`,k=s.css`
  ...
  text-decoration: none;
  &:hover {
    background-color: ${h.theme.colors.dark1};
  }
`,j=s.css`
  flex: 1 1 1px;
`,P=s.css`
...
`,A=s.css`
  overflow: hidden;
`;t.DocumentationPage=()=>{const{page:e}=(0,d.useParams)(),t=e??"OpenAPI_GettingStarted";return l.default.createElement(p.AppContainer,{direction:"horizontal",className:A},l.default.createElement("div",{className:g},l.default.createElement("a",{className:b,href:"#"},l.default.createElement(u.Logo,{width:60}),l.default.createElement("div",{className:y},l.default.createElement("h1",{className:v},"Oats ",l.default.createElement("span",{className:x},"docs")),l.default.createElement("span",{className:O},"v",i.version))),f.sections.map((e=>l.default.createElement(l.Fragment,{key:e.name},l.default.createElement("div",{className:_},e.name),l.default.createElement("div",{className:w},e.items.map((e=>{const n=`#/documentation/${e.md}`,o=e.md===t,a=o?(0,s.cx)(k,P):k;return l.default.createElement("a",{href:n,className:a},l.default.createElement("span",{className:j},e.name)," ",o&&l.default.createElement(c.HiChevronRight,null))}))))))),l.default.createElement("div",{className:I},l.default.createElement(m.MarkdownView,{page:t})))}},21704:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.docs=t.sections=void 0;const o=n(96486);t.sections=[{name:"Guides",items:[{md:"OpenAPI_GettingStarted",name:"Getting started"},{md:"OpenAPI_Sdk",name:"Generated SDK"},{md:"OpenAPI_Server",name:"Generated server"},{md:"OpenAPI_CustomGenerator",name:"Custom generators"}]},{name:"Api",items:[{md:"OpenAPI_Read",name:"Read"},{md:"OpenAPI_Validate",name:"Validate"},{md:"OpenAPI_Generate",name:"Generate"},{md:"Typescript_Write",name:"Write"}]}],t.docs=(0,o.flatMap)(t.sections,(e=>e.items))},16381:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.LandingPage=void 0;const a=o(n(67294)),r=n(4151),s=n(55050),i=n(20364),l=n(48732),c=n(73976),d=n(56005),p=n(12872);t.LandingPage=()=>a.default.createElement(p.AppContainer,{direction:"vertical"},a.default.createElement(c.Header,null),a.default.createElement(r.Content,null,a.default.createElement(l.HeroSection,null),a.default.createElement(i.Headlines,null),a.default.createElement(d.QuickStart,null)),a.default.createElement(s.Footer,null))},61329:(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.theme=void 0,t.theme={colors:{dark1:"#323232",dark2:"#212121",text:"#ffffff",muted:"#aaaaaa",green:"#238636",button:"#eeeeee",buttonHover:"#444444"},font:{code:"1.1rem",s:"1rem",m:"1.2rem",l:"1.8rem",xl:"2rem"}}}},a={};function r(e){var t=a[e];if(void 0!==t)return t.exports;var n=a[e]={id:e,loaded:!1,exports:{}};return o[e].call(n.exports,n,n.exports,r),n.loaded=!0,n.exports}r.m=o,e=[],r.O=(t,n,o,a)=>{if(!n){var s=1/0;for(d=0;d<e.length;d++){for(var[n,o,a]=e[d],i=!0,l=0;l<n.length;l++)(!1&a||s>=a)&&Object.keys(r.O).every((e=>r.O[e](n[l])))?n.splice(l--,1):(i=!1,a<s&&(s=a));if(i){e.splice(d--,1);var c=o();void 0!==c&&(t=c)}}return t}a=a||0;for(var d=e.length;d>0&&e[d-1][2]>a;d--)e[d]=e[d-1];e[d]=[n,o,a]},r.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return r.d(t,{a:t}),t},n=Object.getPrototypeOf?e=>Object.getPrototypeOf(e):e=>e.__proto__,r.t=function(e,o){if(1&o&&(e=this(e)),8&o)return e;if("object"==typeof e&&e){if(4&o&&e.__esModule)return e;if(16&o&&"function"==typeof e.then)return e}var a=Object.create(null);r.r(a);var s={};t=t||[null,n({}),n([]),n(n)];for(var i=2&o&&e;"object"==typeof i&&!~t.indexOf(i);i=n(i))Object.getOwnPropertyNames(i).forEach((t=>s[t]=()=>e[t]));return s.default=()=>e,r.d(a,s),a},r.d=(e,t)=>{for(var n in t)r.o(t,n)&&!r.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},r.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),r.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),r.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},r.nmd=e=>(e.paths=[],e.children||(e.children=[]),e),(()=>{var e={179:0};r.O.j=t=>0===e[t];var t=(t,n)=>{var o,a,[s,i,l]=n,c=0;if(s.some((t=>0!==e[t]))){for(o in i)r.o(i,o)&&(r.m[o]=i[o]);if(l)var d=l(r)}for(t&&t(n);c<s.length;c++)a=s[c],r.o(e,a)&&e[a]&&e[a][0](),e[a]=0;return r.O(d)},n=self.webpackChunk_oats_ts_gh_docs=self.webpackChunk_oats_ts_gh_docs||[];n.forEach(t.bind(null,0)),n.push=t.bind(null,n.push.bind(n))})();var s=r.O(void 0,[833],(()=>r(12299)));s=r.O(s)})();
