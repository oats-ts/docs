...
`,c=a.css`
  label: vertical;
  flex-direction: row;
`;t.AppContainer=({children:e,direction:t})=>{const n=(0,a.cx)(s,"horizontal"===t?c:l);return r.default.createElement("div",{className:n},e)}},79514:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Button=void 0;const a=n(18592),r=o(n(67294)),i=n(61329),s=a.css`
...
`,v=s.css`
  color: ${m.theme.colors.text};
  font-size: ${m.theme.font.m};
`,y=Object.keys(u.markdown),x=e=>y.some((t=>e.startsWith(t)))?"Home"===e?"#":`#/docs/${e}`:(0,d.uriTransformer)(e),w=[p.default],O={h1:({children:e})=>c.default.createElement("h1",{className:g},e),h2:({children:e})=>c.default.createElement("h2",{className:b},e),h3:({children:e})=>c.default.createElement("h3",{className:v},e),table:({className:e,children:t})=>c.default.createElement("table",{className:e},t),a:({href:e,children:t})=>c.default.createElement(h.Link,{href:e},t),code({node:e,inline:t,className:n,children:o,...a}){const r=/language-(\w+)/.exec(n||"");return null===r||t?c.default.createElement("code",{className:n,...a},o):c.default.createElement(f.SyntaxHighlighter,{language:r[1]},String(o).replace(/\n$/,""))}};t.MarkdownView=({page:e})=>(0,l.isNil)(e)||(0,l.isNil)(u.markdown[e])?c.default.createElement("div",null,"The documentation page you are looking for doesn't exist."):c.default.createElement(d.default,{remarkPlugins:w,components:O,transformLinkUri:x},u.markdown[e])},20012:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MenuItem=void 0;const a=n(18592),r=o(n(67294)),i=n(61329),s=a.css`
...
`},12299:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0});const a=n(26729),r=o(n(67294)),i=n(20745),s=n(49818),l=n(78135),c=n(72050);(0,i.createRoot)(document.getElementById("root")).render(r.default.createElement(s.HashRouter,null,r.default.createElement(a.Global,{styles:c.globalStyles}),r.default.createElement(l.AppV2,null)))},95462:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.DocumentationPage=void 0;const a=n(18592),r=n(67535),i=o(n(67294)),s=n(12872),l=n(15435),c=n(76197),d=n(61329),p=a.css`
...
`,h=a.css`
  ...
  margin: 0px;
  padding: 0px;
  font-size: ${d.theme.font.l};
  color: ${d.theme.colors.text};
`,f=a.css`
  color: ${d.theme.colors.muted};
`,g=a.css`
  font-size: ${d.theme.font.s};
  color: ${d.theme.colors.muted};
`,b=a.css`
  ...
  cursor: pointer;
  &:hover {
    background-color: ${d.theme.colors.dark1};
  }
`,v=a.css`
  font-size: ${d.theme.font.m};
  color: ${d.theme.colors.text};
