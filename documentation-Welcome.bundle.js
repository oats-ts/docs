...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:n,host:a})=>{const[r,i]=(0,s.useState)(!1),[d,m]=(0,s.useState)(!1),[p,y]=(0,s.useState)(void 0),_=(0,l.cx)("editor"===a?x:v),k=g[n],w=(0,l.cx)(b);return s.default.createElement("div",{className:_,onMouseEnter:()=>{m(!0)},onMouseLeave:()=>{m(!1)}},s.default.createElement(c.Prism,{language:t,style:k,wrapLongLines:o,showLineNumbers:"editor"===a},e),s.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(p)||(clearTimeout(p),y(void 0)),i(t),y(setTimeout((()=>{i(!1)}),2e3))}},s.default.createElement("button",{className:w,style:{opacity:d?1:0}},r?s.default.createElement(h.HiCheck,null):s.default.createElement(h.HiClipboard,null))))}},66999:function(e,t,o){var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const a=o(18592),r=n(o(67294)),i=o(19446),l=a.css`
