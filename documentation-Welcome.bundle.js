...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:n,host:a,renderer:r})=>{const[i,d]=(0,s.useState)(!1),[f,y]=(0,s.useState)(void 0),k="editor"===a?x:v;return s.default.createElement("div",{className:k},s.default.createElement(c.Prism,{language:t,style:g[n],wrapLongLines:o,showLineNumbers:"editor"===a,...(0,p.isNil)(r)?{}:{renderer:r}},e),s.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,p.isNil)(f)||(clearTimeout(f),y(void 0)),d(t),y(setTimeout((()=>{d(!1)}),2e3))}},s.default.createElement("button",{className:(_=b[n],l.css`
...
`)},i?s.default.createElement(h.HiCheck,null):s.default.createElement(h.HiClipboard,null))));var _}},66999:function(e,t,o){var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const a=o(18592),r=n(o(67294)),i=o(19446),l=a.css`
