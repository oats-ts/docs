...
`;t.MultiAutocomplete=function({items:e,placeholder:t,value:n,isRemoveable:r=(()=>!0),getKey:o=(e=>`${e}`),getValue:a=(e=>`${e}`),getDescription:g=(()=>{}),onChange:b=(()=>{})}){const[y,v]=(0,i.useState)(""),w=e=>{n?.includes(e)||b([...n??[],e])},x=(0,i.useMemo)((()=>{if((0,c.isNil)(y)||0===y.length)return e;const t=e.filter((e=>a(e).toLowerCase().includes(y.toLowerCase())));return 0===t.length?[y]:t}),[n,e,y]),_=!(0,c.isEmpty)(n),O=!(0,c.isEmpty)(y),{isOpen:E,highlightedIndex:P,getToggleButtonProps:k,getLabelProps:S,getMenuProps:C,getItemProps:j,getInputProps:$}=(0,s.useCombobox)({selectedItem:null,items:x,defaultHighlightedIndex:0,onStateChange:({type:e,selectedItem:t})=>{switch(e){case s.useCombobox.stateChangeTypes.InputKeyDownEnter:(0,c.isNil)(P)&&O?w(y):(0,c.isNil)(t)||w(t),v("");break;case s.useCombobox.stateChangeTypes.ItemClick:w(t),v("")}}}),{onFocus:I,...A}=$({onKeyDown:e=>{"Backspace"===e.key&&!O&&_&&b(n.slice(0,-1))},onChange:e=>{e.stopPropagation(),e.preventDefault(),v(e.target.value)},onBlur:()=>{y.length>0&&(w(y),v(""))}});return i.default.createElement("div",{className:(0,p.dropdownContainerStyle)(E)},i.default.createElement("div",{className:f,...k()},_&&i.default.createElement("label",{className:h,...S()},n?.map((e=>i.default.createElement(m.Chip,{label:a(e),key:o(e),removeable:r(e),onRemove:()=>(e=>{b?.((n??[]).filter((t=>t!==e)))})(e)})))),i.default.createElement("input",{...A,className:(M=!_,d.css`
  label: input;
  border-width: ${u.theme.spacing.zero};
  outline: none;
  border-radius: ${u.theme.spacing.s};
  flex: ${u.theme.flex.grow};
  padding: ${u.theme.spacing.m} ${u.theme.spacing.zero} ${u.theme.spacing.m} ${M?u.theme.spacing.xm:u.theme.spacing.xs};
  color: ${u.theme.colors.text};
  background-color: ${u.theme.colors.transparent};
  ::placeholder {
    color: ${u.theme.colors.placeholder};
  }
`),placeholder:_?"":t,value:y}),i.default.createElement(l.HiChevronDown,{color:u.theme.colors.text})),i.default.createElement("ul",{...C(),className:p.dropdownStyle},E&&x.map(((e,t)=>{const r=n?.includes(e),s=P===t,u=(0,d.cx)(p.dropdownItemStyle,s?p.focusedDropownItemStyle:void 0,r?p.selectedDropdownItemStyle:void 0),m=a(e),f=o(e),h=g(e);return i.default.createElement("li",{className:u,key:`${f}${t}`,...j({item:e,index:t})},i.default.createElement("span",{className:p.dropdownItemLabelStyle},r?i.default.createElement(l.HiCheck,null):void 0,m),(0,c.isNil)(h)?null:i.default.createElement("span",{className:p.dropdownItemDescriptionStyle},h))}))));var M}},63408:function(e,t,n){"use strict";var r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MultiSelect=void 0;const o=r(n(67294)),a=n(88899),i=n(67453),s=n(96486),l=n(18592),c=n(61329),d=n(48228),u=n(9849),p=l.css`
