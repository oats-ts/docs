...
`,g=(0,n.cx)(h,n.css`
  ...
  display: flex;
  flex-direction: column;
`;t.Content=({children:e})=>n.default.createElement("main",{className:(0,a.cx)(s,i.ctnr)},e)},40782:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.DocContainer=void 0;const n=r(18592),a=o(r(67294)),i=r(61329),s=n.css`
  label: doc-container;
  max-width: 100vw;
  max-height: 100vh;
  width: 100vw;
...
`,d=n.css`
  font-size: ${s.theme.fontSize.s};
  color: ${s.theme.colors.muted};
`;t.FormSection=({children:e,name:t,description:r})=>i.default.createElement("section",{className:l},i.default.createElement("label",{className:c},t),(0,a.isNil)(r)?null:i.default.createElement("span",{className:d},r),e)},73976:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Header=void 0;const n=r(18592),a=o(r(67294)),i=r(67453),s=r(158),l=r(20012),c=r(16045),d=r(55023),u=n.css`
  label: header;
  width: 100%;
  margin: 0px;
  padding: 0px;
...
`;t.Header=()=>a.default.createElement("header",{className:u},a.default.createElement("div",{className:(0,n.cx)(p,s.ctnr)},a.default.createElement(c.MenuLogo,null),a.default.createElement(d.MenuBar,null,a.default.createElement(l.MenuItem,{label:"Home",icon:i.HiHome,href:"#/",active:!0}),a.default.createElement(l.MenuItem,{label:"Documentation",icon:i.HiDocument,href:"#/documentation"}),a.default.createElement(l.MenuItem,{label:"Editor",icon:i.HiCog6Tooth,href:"#/editor"}))))},20364:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Headlines=void 0;const n=r(18592),a=o(r(67294)),i=r(67453),s=r(61329),l=r(79514),c=r(158),d=n.css`
  label: headlines;
  display: flex;
  flex-direction: row;
  gap: 24px;
...
`,h=n.css`
  ...
  display: flex;
  gap: 12px;
`;t.HeroSection=()=>a.default.createElement("div",{className:u},a.default.createElement("div",{className:(0,n.cx)(l.ctnr,p)},a.default.createElement("h2",{className:f},"Generate TypeScript from OpenAPI, that makes sense."),a.default.createElement("h3",{className:m},"Customizable, extensible and ",a.default.createElement("b",null,"open source")," code generators, that output quality"," ",a.default.createElement(d.Link,{href:"https://www.typescriptlang.org"},"TypeScript"),", from your"," ",a.default.createElement(d.Link,{href:"https://www.openapis.org"},"OpenAPI")," definitions."),a.default.createElement("div",{className:h},a.default.createElement(s.Button,{variant:"primary"},a.default.createElement(c.HiPlay,null)," Get Started"),a.default.createElement(s.Button,null,a.default.createElement(c.HiCodeBracket,null)," Github"))))},9155:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Input=void 0;const n=o(r(67294)),a=r(18592),i=r(61329),s=a.css`
  label: input;
  width: 100%;
  background-color: ${i.theme.colors.dark1};
  color: ${i.theme.colors.text};
...
`,h=d.css`
  ...
  gap: 6px;
  padding-left: 12px;
`;t.MultiAutocomplete=function({items:e,placeholder:t,value:r,isRemoveable:o=(()=>!0),getKey:n=(e=>`${e}`),getValue:a=(e=>`${e}`),getDescription:g=(()=>{}),onChange:b=(()=>{})}){const[y,v]=(0,i.useState)(""),x=e=>{r?.includes(e)||b([...r??[],e])},w=(0,i.useMemo)((()=>{if((0,c.isNil)(y)||0===y.length)return e;const t=e.filter((e=>a(e).toLowerCase().includes(y.toLowerCase())));return 0===t.length?[y]:t}),[r,e,y]),_=!(0,c.isEmpty)(r),O=!(0,c.isEmpty)(y),{isOpen:E,highlightedIndex:P,getToggleButtonProps:S,getLabelProps:k,getMenuProps:C,getItemProps:j,getInputProps:I}=(0,s.useCombobox)({selectedItem:null,items:w,defaultHighlightedIndex:0,onStateChange:({type:e,selectedItem:t})=>{switch(e){case s.useCombobox.stateChangeTypes.InputKeyDownEnter:(0,c.isNil)(P)&&O?x(y):(0,c.isNil)(t)||x(t),v("");break;case s.useCombobox.stateChangeTypes.ItemClick:x(t),v("")}}}),{onFocus:A,...M}=I({onKeyDown:e=>{"Backspace"===e.key&&!O&&_&&b(r.slice(0,-1))},onChange:e=>{e.stopPropagation(),e.preventDefault(),v(e.target.value)},onBlur:()=>{y.length>0&&(x(y),v(""))}});return i.default.createElement("div",{className:(0,p.dropdownContainerStyle)(E)},i.default.createElement("div",{className:m,...S()},_&&i.default.createElement("label",{className:h,...k()},r?.map((e=>i.default.createElement(f.Chip,{label:a(e),key:n(e),removeable:o(e),onRemove:()=>(e=>{b?.((r??[]).filter((t=>t!==e)))})(e)})))),i.default.createElement("input",{...M,className:(T=!_,d.css`
  label: input;
  border-width: 0px;
  outline: none;
  border-radius: 8px;
...
`,x=i.css`
  ...
  top: 18px;
  right: 18px;
`;t.SyntaxHighlighter=({children:e,language:t,kind:r})=>{const[o,n]=(0,s.useState)(!1),[a,c]=(0,s.useState)(!1),[u,m]=(0,s.useState)(void 0),w=(0,i.cx)("editor"===r?v:y),_="editor"===r?g:h,O=(0,i.cx)(b,"editor"===r?x:void 0);return s.default.createElement("div",{className:w,onMouseEnter:()=>{c(!0)},onMouseLeave:()=>{c(!1)}},s.default.createElement(l.Prism,{language:t,style:_,wrapLongLines:!0,showLineNumbers:"editor"===r},e),s.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(u)||(clearTimeout(u),m(void 0)),n(t),m(setTimeout((()=>{n(!1)}),2e3))}},s.default.createElement("button",{className:O,style:{opacity:a?1:0}},o?s.default.createElement(p.HiCheck,null):s.default.createElement(p.HiClipboard,null))))}},89937:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const n=r(18592),a=o(r(67294)),i=r(61329),s=n.css`
  border-radius: 10px;
