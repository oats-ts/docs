...
`;t.Select=function({items:e,placeholder:t,value:r,onChange:n,getKey:m=(e=>`${e}`),getValue:h=(e=>`${e}`),getDescription:g=(()=>{})}){const{isOpen:b,getToggleButtonProps:y,getLabelProps:v,getMenuProps:x,highlightedIndex:w,getItemProps:_}=(0,a.useSelect)({items:e,onSelectedItemChange:e=>n?.(e.selectedItem)});return o.default.createElement("div",{className:(0,d.dropdownContainerStyle)(b)},o.default.createElement("div",{className:u,...y()},o.default.createElement("label",{className:p,...v()},(0,s.isNil)(r)?o.default.createElement("span",{className:f},t):h(r)),o.default.createElement(i.HiChevronDown,{color:c.theme.colors.text})),o.default.createElement("ul",{...x(),className:d.dropdownStyle},b&&e.map(((e,t)=>{const r=(0,l.cx)(d.dropdownItemStyle,w===t?d.focusedDropownItemStyle:void 0),n=h(e),a=m(e),i=g(e);return o.default.createElement("li",{className:r,key:`${a}${t}`,..._({item:e,index:t})},o.default.createElement("span",{className:d.dropdownItemLabelStyle},n),(0,s.isNil)(i)?null:o.default.createElement("span",{className:d.dropdownItemDescriptionStyle},i))}))))}},39201:function(e,t,r){"use strict";var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.SideBar=void 0;const o=r(18592),a=n(r(67294)),i=r(61329),s=o.css`
  label: side-bar;
  width: 350px;
  display: flex;
  flex-direction: column;
...
`,d=o.css`
  ...
  align-items: center;
  gap: 4px;
`,u=({isContainer:e,isOpen:t,isEmpty:r})=>e?r?a.default.createElement(i.HiChevronLeft,null):t?a.default.createElement(i.HiChevronDown,null):a.default.createElement(i.HiChevronRight,null):null;t.TreeNode=function e({value:t,level:r,getLabel:n,isActive:i=(()=>!1),isOpen:s=(()=>!1),isContainer:p=(()=>!1),getChildren:f=(()=>[]),onClick:m=(()=>{}),getHref:h=(()=>{}),getIcon:g=(()=>{})}){const b=f(t),y=s(t),v=i(t),x=p(t),w=g(t),_=x&&y?(0,o.cx)(l,(e=>o.css`
  &::before {
    z-index: 5;
...
`,y=i.css`
  overflow: hidden;
`;t.DocumentationPage=()=>{const{page:e}=(0,l.useParams)(),t=e??"OpenAPI_GettingStarted";return s.default.createElement(c.AppContainer,{direction:"horizontal",className:y},s.default.createElement(u.SideBar,null,s.default.createElement(p.SideBarLogo,{name:"docs"}),g.sections.map((e=>s.default.createElement(s.Fragment,{key:e.name},s.default.createElement(f.SideBarSection,{title:e.name},e.items.map((e=>s.default.createElement(h.DocumentationTreeRoot,{node:e,key:e.md})))))))),s.default.createElement("div",{className:b},s.default.createElement(d.MarkdownView,{page:t})))}},21521:function(e,t,r){"use strict";var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.DocumentationTreeRoot=void 0;const o=n(r(67294)),a=r(5838),i=r(49818);t.DocumentationTreeRoot=({node:e})=>{const{page:t="OpenAPI_GettingStarted"}=(0,i.useParams)();return o.default.createElement(a.TreeNode,{value:e,level:0,getLabel:e=>e.name,isActive:e=>e.md===t,getHref:e=>`#/documentation/${e.md}`})}},17222:function(e,t,r){"use strict";var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.QuickStart=void 0;const o=r(18592),a=n(r(67294)),i=r(60155),s=r(61329),l=r(43418),c=r(7807),d=r(86299),u=n(r(26360)),p=n(r(70629)),f=r(41298),m=o.css`
  label: quick-start;
  margin-bottom: 40px;
`,h=o.css`
