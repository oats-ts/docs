...
`;t.MultiAutocomplete=function({items:e,placeholder:t,value:r,isRemoveable:n=(()=>!0),getKey:o=(e=>`${e}`),getValue:a=(e=>`${e}`),getDescription:g=(()=>{}),onChange:b=(()=>{})}){const[y,v]=(0,i.useState)(""),w=e=>{r?.includes(e)||b([...r??[],e])},_=(0,i.useMemo)((()=>{if((0,c.isNil)(y)||0===y.length)return e;const t=e.filter((e=>a(e).toLowerCase().includes(y.toLowerCase())));return 0===t.length?[y]:t}),[r,e,y]),x=!(0,c.isEmpty)(r),O=!(0,c.isEmpty)(y),{isOpen:E,highlightedIndex:P,getToggleButtonProps:S,getLabelProps:C,getMenuProps:k,getItemProps:$,getInputProps:j}=(0,s.useCombobox)({selectedItem:null,items:_,defaultHighlightedIndex:0,onStateChange:({type:e,selectedItem:t})=>{switch(e){case s.useCombobox.stateChangeTypes.InputKeyDownEnter:(0,c.isNil)(P)&&O?w(y):(0,c.isNil)(t)||w(t),v("");break;case s.useCombobox.stateChangeTypes.ItemClick:w(t),v("")}}}),{onFocus:M,...I}=j({onKeyDown:e=>{"Backspace"===e.key&&!O&&x&&b(r.slice(0,-1))},onChange:e=>{e.stopPropagation(),e.preventDefault(),v(e.target.value)},onBlur:()=>{y.length>0&&(w(y),v(""))}});return i.default.createElement("div",{className:(0,m.dropdownContainerStyle)(E)},i.default.createElement("div",{className:f,...S()},x&&i.default.createElement("label",{className:h,...C()},r?.map((e=>i.default.createElement(p.Chip,{label:a(e),key:o(e),removeable:n(e),onRemove:()=>(e=>{b?.((r??[]).filter((t=>t!==e)))})(e)})))),i.default.createElement("input",{...I,className:(A=!x,d.css`
  label: input;
  border-width: ${u.theme.spacing.zero};
  outline: none;
  border-radius: ${u.theme.spacing.s};
