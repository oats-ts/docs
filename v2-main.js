...
`,h=d.css`
  ...
  gap: 6px;
  padding-left: 12px;
`;t.MultiAutocomplete=function({items:e,placeholder:t,value:r,isRemoveable:o=(()=>!0),getKey:n=(e=>`${e}`),getValue:a=(e=>`${e}`),getDescription:g=(()=>{}),onChange:b=(()=>{})}){const[y,v]=(0,i.useState)(""),w=e=>{r?.includes(e)||b([...r??[],e])},x=(0,i.useMemo)((()=>{if((0,c.isNil)(y)||0===y.length)return e;const t=e.filter((e=>a(e).toLowerCase().includes(y.toLowerCase())));return 0===t.length?[y]:t}),[r,e,y]),_=!(0,c.isEmpty)(r),O=!(0,c.isEmpty)(y),{isOpen:E,highlightedIndex:P,getToggleButtonProps:S,getLabelProps:k,getMenuProps:C,getItemProps:j,getInputProps:I}=(0,s.useCombobox)({selectedItem:null,items:x,defaultHighlightedIndex:0,onStateChange:({type:e,selectedItem:t})=>{switch(e){case s.useCombobox.stateChangeTypes.InputKeyDownEnter:(0,c.isNil)(P)&&O?w(y):(0,c.isNil)(t)||w(t),v("");break;case s.useCombobox.stateChangeTypes.ItemClick:w(t),v("")}}}),{onFocus:A,...M}=I({onKeyDown:e=>{"Backspace"===e.key&&!O&&_&&b(r.slice(0,-1))},onChange:e=>{e.stopPropagation(),e.preventDefault(),v(e.target.value)},onBlur:()=>{y.length>0&&(w(y),v(""))}});return i.default.createElement("div",{className:(0,p.dropdownContainerStyle)(E)},i.default.createElement("div",{className:m,...S()},_&&i.default.createElement("label",{className:h,...k()},r?.map((e=>i.default.createElement(f.Chip,{label:a(e),key:n(e),removeable:o(e),onRemove:()=>(e=>{b?.((r??[]).filter((t=>t!==e)))})(e)})))),i.default.createElement("input",{...M,className:(T=!_,d.css`
  label: input;
  border-width: 0px;
  outline: none;
  border-radius: 8px;
...
`),placeholder:_?"":t,value:y}),i.default.createElement(l.HiChevronDown,{color:u.theme.colors.text})),i.default.createElement("ul",{...C(),className:p.dropdownStyle},E&&x.map(((e,t)=>{const o=r?.includes(e),s=P===t,u=(0,d.cx)(p.dropdownItemStyle,s?p.focusedDropownItemStyle:void 0,o?p.selectedDropdownItemStyle:void 0),f=a(e),m=n(e),h=g(e);return i.default.createElement("li",{className:u,key:`${m}${t}`,...j({item:e,index:t})},i.default.createElement("span",{className:p.dropdownItemLabelStyle},o?i.default.createElement(l.HiCheck,null):void 0,f),(0,c.isNil)(h)?null:i.default.createElement("span",{className:p.dropdownItemDescriptionStyle},h))}))));var T}},63408:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MultiSelect=void 0;const n=o(r(67294)),a=r(88899),i=r(67453),s=r(96486),l=r(18592),c=r(61329),d=r(48228),u=r(9849),p=l.css`
  flex: 1 1 1px;
  color: ${c.theme.colors.text};
  display: flex;
  flex-direction: row;
...
`;t.SideBar=({children:e})=>a.default.createElement("div",{className:l},e)},19343:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.SideBarLogo=void 0;const n=r(18592),a=r(67535),i=o(r(67294)),s=r(61329),l=r(15435),c=n.css`
  label: side-bar-logo;
  display: flex;
  gap: 10px;
  align-items: center;
...
`,w=i.css`
  ...
  top: 18px;
  right: 18px;
`;t.SyntaxHighlighter=({children:e,language:t,kind:r})=>{const[o,n]=(0,s.useState)(!1),[a,c]=(0,s.useState)(!1),[u,m]=(0,s.useState)(void 0),x=(0,i.cx)("editor"===r?v:y),_="editor"===r?g:h,O=(0,i.cx)(b,"editor"===r?w:void 0);return s.default.createElement("div",{className:x,onMouseEnter:()=>{c(!0)},onMouseLeave:()=>{c(!1)}},s.default.createElement(l.Prism,{language:t,style:_,wrapLongLines:!0,showLineNumbers:"editor"===r},e),s.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(u)||(clearTimeout(u),m(void 0)),n(t),m(setTimeout((()=>{n(!1)}),2e3))}},s.default.createElement("button",{className:O,style:{opacity:a?1:0}},o?s.default.createElement(p.HiCheck,null):s.default.createElement(p.HiClipboard,null))))}},89937:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const n=r(18592),a=o(r(67294)),i=r(61329),s=n.css`
  border-radius: 10px;
...
`;t.DocumentationPage=()=>{const{page:e}=(0,l.useParams)(),t=e??"OpenAPI_GettingStarted";return s.default.createElement(c.DocContainer,null,s.default.createElement(u.SideBar,null,s.default.createElement(p.SideBarLogo,{name:"docs"}),g.sections.map((e=>s.default.createElement(s.Fragment,{key:e.name},s.default.createElement(f.SideBarSection,{title:e.name},e.items.map((e=>s.default.createElement(h.DocumentationTreeRoot,{node:e,key:e.md})))))))),s.default.createElement("div",{className:b},s.default.createElement(d.MarkdownView,{page:t})))}},21521:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.DocumentationTreeRoot=void 0;const n=o(r(67294)),a=r(5838),i=r(49818);t.DocumentationTreeRoot=({node:e})=>{const{page:t="OpenAPI_GettingStarted"}=(0,i.useParams)();return n.default.createElement(a.TreeNode,{value:e,level:0,getLabel:e=>e.name,isActive:e=>e.md===t,getHref:e=>`#/documentation/${e.md}`})}},17222:function(e,t,r){"use strict";var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.QuickStart=void 0;const n=r(18592),a=o(r(67294)),i=r(67453),s=r(61329),l=r(43418),c=r(7807),d=r(86299),u=o(r(26360)),p=o(r(70629)),f=r(41298),m=n.css`
  label: quick-start;
  margin-bottom: 40px;
`,h=n.css`
