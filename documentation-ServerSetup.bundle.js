...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:n,host:r})=>{const[a,s]=(0,l.useState)(!1),[d,m]=(0,l.useState)(!1),[f,k]=(0,l.useState)(void 0),y=(0,i.cx)("editor"===r?x:v),_=g[n],w=(0,i.cx)(b);return l.default.createElement("div",{className:y,onMouseEnter:()=>{m(!0)},onMouseLeave:()=>{m(!1)}},l.default.createElement(c.Prism,{language:t,style:_,wrapLongLines:o,showLineNumbers:"editor"===r},e),l.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,h.isNil)(f)||(clearTimeout(f),k(void 0)),s(t),k(setTimeout((()=>{s(!1)}),2e3))}},l.default.createElement("button",{className:w,style:{opacity:d?1:0}},a?l.default.createElement(p.HiCheck,null):l.default.createElement(p.HiClipboard,null))))}},66999:function(e,t,o){var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const r=o(18592),a=n(o(67294)),s=o(19446),i=r.css`
