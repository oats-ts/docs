...
`,_=Object.values(p.markdownPages),P=e=>{const t=_.find((t=>e.startsWith(t.md)));return(0,c.isNil)(t)?e===encodeURIComponent("{{documentation}}")?m.links.docs():e===encodeURIComponent("{{editor}}")?m.links.editor():(0,d.uriTransformer)(e):m.links.doc(t.md)},O=[u.default];t.MarkdownView=({content:e,syntaxHighlighterProps:t={}})=>{const o=(0,l.useMemo)((()=>{return e=t,{h1:({children:e})=>l.default.createElement("h1",{className:y},e),h2:({children:e})=>l.default.createElement("h2",{className:x},e),h3:({children:e})=>l.default.createElement("h3",{className:k},e),table:({children:e})=>l.default.createElement(v.Table,null,e),tr:({children:e,isHeader:t})=>l.default.createElement(v.Tr,{isHeader:t},e),th:({children:e})=>l.default.createElement(v.Th,null,e),td:({children:e})=>l.default.createElement(v.Td,null,e),a:({href:e,children:t})=>l.default.createElement(f.Link,{href:e},t),code({node:t,inline:o,className:a,children:n,...r}){const s=/language-(\w+)/.exec(a||"");return null===s||o?l.default.createElement(g.Code,{...r},n):l.default.createElement(b.SyntaxHighlighter,{language:s[1],host:e.host??"docs",theme:e.theme??"medium",lineWrap:e.lineWrap??!1},String(n).replace(/\n$/,""))},blockquote:({children:e})=>l.default.createElement("div",{className:w},e)};var e}),[t.host,t.lineWrap,t.theme]);return l.default.createElement(d.default,{remarkPlugins:O,components:o,transformLinkUri:P},e??"")}},96487:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MenuTreeItem=void 0;const n=a(o(67294)),r=o(69274),s=o(77255),i=o(7117),c=o(82067),l={index:"Home",docs:"Documentation",editor:"Editor"},d={index:r.HiHome,docs:r.HiDocument,editor:r.HiCog6Tooth};t.MenuTreeItem=({link:e})=>{const{setMenuOpen:t}=(0,i.useMobileContext)();return n.default.createElement(c.TreeNode,{value:void 0,level:0,getIcon:()=>d[e],getLabel:()=>l[e],isActive:()=>!1,onClick:()=>t(!1),getHref:()=>s.links[e]()})}},7117:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.useProvideMobileContext=t.useMobileContext=t.MobileContext=void 0;const a=o(96486),n=o(67294);t.MobileContext=(0,n.createContext)({isMenuOpen:!1,setMenuOpen:a.noop}),t.useMobileContext=()=>(0,n.useContext)(t.MobileContext),t.useProvideMobileContext=()=>{const[e,t]=(0,n.useState)(!1);return{isMenuOpen:e,setMenuOpen:t}}},35625:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.MobileHeader=void 0;const n=o(18592),r=a(o(67294)),s=o(19446),i=o(19187),c=o(66118),l=n.css`
  display: flex;
  flex-direction: row;
...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:a,host:n,renderer:r})=>{const[s,d]=(0,c.useState)(!1),[g,x]=(0,c.useState)(void 0),k="editor"===n?y:v;return c.default.createElement("div",{className:k},c.default.createElement(l.Prism,{language:t,style:f[a],wrapLongLines:o,showLineNumbers:"editor"===n,...(0,h.isNil)(r)?{}:{renderer:r}},e),c.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,h.isNil)(g)||(clearTimeout(g),x(void 0)),d(t),x(setTimeout((()=>{d(!1)}),2e3))}},c.default.createElement("button",{className:(w=b[a],i.css`
...
`)},s?c.default.createElement(m.HiCheck,null):c.default.createElement(m.HiClipboard,null))));var w}},66999:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const n=o(18592),r=a(o(67294)),s=o(19446),i=n.css`
...
`,u=n.css`
  margin-left: 0.6rem;
`,p=({isOpen:e,isEmpty:t})=>t?r.default.createElement(s.HiChevronLeft,null):e?r.default.createElement(s.HiChevronDown,null):r.default.createElement(s.HiChevronRight,null);t.TreeNode=function e({value:t,level:o,getLabel:a,isActive:s=(()=>!1),isOpen:i=(()=>!1),isContainer:m=(()=>!1),getChildren:h=(()=>[]),onClick:g=(()=>{}),getHref:f=(()=>{}),getIcon:b=(()=>{})}){const v=h(t),y=i(t),x=s(t),k=m(t),w=b(t),_=k&&y?(0,n.cx)(c,(e=>n.css`
  &::before {
    z-index: 5;
...
`)(o)):c,P=f(t),O=a(t),S=!(k||void 0!==w||0===o);return r.default.createElement("div",{className:_},r.default.createElement("a",{className:l(o,x),href:P,onClick:()=>g(t,y)},r.default.createElement("span",{className:d},k&&r.default.createElement(p,{isEmpty:0===v.length,isOpen:y}),void 0===w?null:r.default.createElement(w,null),S?r.default.createElement("span",{className:u},O):r.default.createElement("span",null,O))),y&&v.map(((t,n)=>r.default.createElement(e,{key:`${n}-${O}`,value:t,level:o+1,getLabel:a,getHref:f,isContainer:m,getChildren:h,isOpen:i,isActive:s,onClick:g}))))}},98452:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.createPrismTheme=void 0;const a=o(96486),n=o(19446);t.createPrismTheme=function(e,t){const o={'pre[class*="language-"]':{backgroundColor:t,borderRadius:n.theme.spacing.zero,padding:n.theme.spacing.xxm,width:"100%",maxWidth:"100%",borderWidth:n.theme.spacing.zero,margin:n.theme.spacing.zero,fontSize:n.theme.fontSize.code,fontFamily:n.theme.fontFamily.monospace}},r=(0,a.cloneDeep)(e);return(0,a.values)(r).forEach((e=>{delete e.background,delete e.backgroundColor,e.textShadow=`rgb(0 0 0 / 30%) ${n.theme.spacing.zero} ${n.theme.spacing.zero} ${n.theme.spacing.xxs}`,e.fontSize=n.theme.fontSize.code,e.fontFamily=n.theme.fontFamily.monospace})),(0,a.merge)(r,o)}},14757:(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.getSizeWithAspectRatio=void 0,t.getSizeWithAspectRatio=function(e,t,o,a){return void 0!==o&&void 0===a?[o,t/e*o]:void 0!==a&&void 0===o?[a,e/t*a]:void 0!==o&&void 0!==a?[o,a]:[e,t]}},63413:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.globalStyles=void 0;const a=o(26729),n=o(80887),r=o(19446);t.globalStyles=a.css`
  #root {
...
`,w=()=>{const e=(0,l.useProvideMobileContext)();return r.default.createElement(l.MobileContext.Provider,{value:e},r.default.createElement(d.MobileHeaderWithOverlay,{name:y,version:!0,href:v.links.docs()},r.default.createElement(g.DocumentationMenu,null)))};t.DocumentationPage=({page:e,content:t})=>r.default.createElement(b.MarkdownContext.Provider,{value:{page:e,content:t}},r.default.createElement(i.DocContainer,null,r.default.createElement(u.SideBar,null,r.default.createElement(m.LogoContainer,null,r.default.createElement(p.Logo,{name:y,version:!0,href:v.links.docs()})),r.default.createElement(g.DocumentationMenu,null)),r.default.createElement("div",{className:x},r.default.createElement(s.BreakPoint,{Component:w,breakpoint:"phone"}),r.default.createElement("div",{className:k},r.default.createElement(c.MarkdownView,{content:t})),r.default.createElement(f.DocumentationFooter,null))))},54711:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.DocumentationTreeRoot=void 0;const n=a(o(67294)),r=o(82067),s=o(7117),i=o(49098),c=o(77255);t.DocumentationTreeRoot=({node:e})=>{const{setMenuOpen:t}=(0,s.useMobileContext)(),{page:o}=(0,i.useMarkdown)();return n.default.createElement(r.TreeNode,{value:e,level:0,getLabel:e=>e.name,isActive:e=>e.md===o,onClick:()=>t(!1),getHref:e=>c.links.doc(e.md)})}},49098:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.useMarkdown=t.MarkdownContext=void 0;const a=o(67294);t.MarkdownContext=(0,a.createContext)({content:"",page:"Welcome"}),t.useMarkdown=()=>(0,a.useContext)(t.MarkdownContext)},10603:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.useNeighbours=void 0;const a=o(96486),n=o(67294),r=o(42946),s=o(49098);function i(e,t,o=0){if((0,a.isNil)(e)||0!==o&&!e.useNavigation)return;const n=function(e,t){return t.items.findIndex((t=>t.md===e))}(t,e)+o;return e.items[n]}t.useNeighbours=function(){const{page:e}=(0,s.useMarkdown)(),t=(0,n.useMemo)((()=>function(e){return r.sections.find((t=>t.items.some((t=>t.md===e))))}(e)),[e]),o=(0,n.useMemo)((()=>i(t,e)),[e,t]);return[(0,n.useMemo)((()=>i(t,e,-1)),[e,t]),o,(0,n.useMemo)((()=>i(t,e,1)),[e,t])]}},19446:(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.theme=void 0,t.theme={colors:{transparent:"transparent",dark1:"#323232",dark2:"#212121",dark3:"#1e1e1e",dark4:"#181818",dark5:"#111111",darkHighlight:"#292929",text:"#ffffff",muted:"#aaaaaa",placeholder:"#777777",green:"#238636",buttonHover:"#444444",transparentWhite:"rgba(255, 255, 255, 0.2)"},fontSize:{code:"1.1rem",xxs:"0.85rem",xs:"0.95rem",s:"1rem",m:"1.2rem",xm:"1.4rem",l:"1.8rem",xl:"2rem",xxl:"2.4rem"},fontFamily:{monospace:"'Source Code Pro', monospace",sansSerif:"'Montserrat', sans-serif"},spacing:{zero:"0rem",xxxs:"0.125rem",xxs:"0.25rem",xs:"0.375rem",s:"0.5rem",m:"0.75rem",xm:"1rem",xxm:"1.125rem",l:"1.5rem",xl:"1.625rem",xxl:"2.125rem",xxxl:"2.5rem",h:"3.75rem",xh:"5rem",xxh:"6.25rem"},flex:{grow:"1 1 1px"}}}},e=>{e(e.s=38251)}]);
