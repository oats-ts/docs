...
`,u=a.css`
  margin-left: 0.6rem;
`,m=({isOpen:e,isEmpty:t})=>t?r.default.createElement(i.HiChevronLeft,null):e?r.default.createElement(i.HiChevronDown,null):r.default.createElement(i.HiChevronRight,null);t.TreeNode=function e({value:t,level:o,getLabel:n,isActive:i=(()=>!1),isOpen:s=(()=>!1),isContainer:p=(()=>!1),getChildren:h=(()=>[]),onClick:f=(()=>{}),getHref:g=(()=>{}),getIcon:b=(()=>{})}){const v=h(t),O=s(t),y=i(t),x=p(t),P=b(t),k=x&&O?(0,a.cx)(c,(e=>a.css`
  &::before {
    z-index: 5;
