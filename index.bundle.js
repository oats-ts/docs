...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:n,theme:o,host:a,renderer:r})=>{const[i,d]=(0,l.useState)(!1),[f,y]=(0,l.useState)(void 0),_="editor"===a?v:x;return l.default.createElement("div",{className:_},l.default.createElement(c.Prism,{language:t,style:g[o],wrapLongLines:n,showLineNumbers:"editor"===a,...(0,p.isNil)(r)?{}:{renderer:r}},e),l.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,p.isNil)(f)||(clearTimeout(f),y(void 0)),d(t),y(setTimeout((()=>{d(!1)}),2e3))}},l.default.createElement("button",{className:(k=b[o],s.css`
...
`)},i?l.default.createElement(h.HiCheck,null):l.default.createElement(h.HiClipboard,null))));var k}},66999:function(e,t,n){var o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const a=n(18592),r=o(n(67294)),i=n(19446),s=a.css`
