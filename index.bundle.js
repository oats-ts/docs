...
`,f=n.css`
  ...
  color: ${s.theme.colors.muted};
`;t.Logo=({name:e,version:t,href:o})=>i.default.createElement("a",{className:d,href:o},i.default.createElement(c.SvgLogo,{width:60}),i.default.createElement("div",{className:m},i.default.createElement("h1",{className:u},"Oats ",(0,l.isNil)(e)?null:i.default.createElement("span",{className:h},e)),t&&i.default.createElement("span",{className:f},"v",r.version)))},19187:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.LogoContainer=void 0;const n=o(18592),r=a(o(67294)),l=o(80887),i=o(19446),s=n.css`
...
`,m=n.css`
  opacity: 0;
  pointer-events: none;
`;t.MobileOverlay=({name:e,children:t,href:o,version:a})=>{const{isMenuOpen:i,setMenuOpen:u}=(0,s.useMobileContext)();return r.default.createElement("div",{className:(0,n.cx)(d,i?void 0:m)},r.default.createElement(c.MobileHeader,{href:o,actionIcon:l.HiXMark,onAction:()=>u(!1),name:e,version:a}),t)}},65601:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.QuickStartItem=void 0;const n=o(18592),r=a(o(67294)),l=o(19446),i=o(80887),s=n.css`
...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:a,host:n,renderer:r})=>{const[l,i]=(0,s.useState)(!1),[d,u]=(0,s.useState)(void 0),p="editor"===n?v:x;return s.default.createElement("div",{className:p},s.default.createElement(c.Prism,{language:t,style:g[a],wrapLongLines:o,showLineNumbers:"editor"===n,...(0,f.isNil)(r)?{}:{renderer:r}},e),s.default.createElement(m.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(d)||(clearTimeout(d),u(void 0)),i(t),u(setTimeout((()=>{i(!1)}),2e3))}},s.default.createElement("button",{className:b},l?s.default.createElement(h.HiCheck,null):s.default.createElement(h.HiClipboard,null))))}},46161:(e,t,o)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.containerStyle=void 0;const a=o(18592),n=o(80887),r=o(19446);t.containerStyle=a.css`
  label: container;
  display: flex;
...
`,h=n.css`
  ...
  flex-direction: row;
  justify-content: space-between;
`;t.Header=()=>r.default.createElement("header",{className:u},r.default.createElement("div",{className:(0,n.cx)(h,l.containerStyle)},r.default.createElement(c.Logo,{version:!1,href:m.links.index()}),r.default.createElement(d.LandingPageMenu,null)))},51442:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Headlines=void 0;const n=o(18592),r=a(o(67294)),l=o(69274),i=o(19446),s=o(78436),c=o(80887),d=o(77255),m=n.css`
  label: headlines;
  display: flex;
  flex-direction: row;
  gap: ${i.theme.spacing.l};
...
`,f=n.css`
  ...
  flex: ${i.theme.flex.grow};
  flex-shrink: 0;
`;t.Headlines=()=>r.default.createElement("div",{className:m},r.default.createElement("div",{className:u},r.default.createElement("h3",{className:h},r.default.createElement(l.HiPuzzlePiece,null),"Generate an SDK"),r.default.createElement("section",{className:f},"Create an easy to use, statically typed SDK for interacting with your backend, with all the bells and whistles! Use it either in house, or expose it to your customers."),r.default.createElement(s.Button,{href:d.links.doc("SdkGettingStarted")},r.default.createElement(l.HiBookOpen,null),"Learn more")),r.default.createElement("div",{className:u},r.default.createElement("h3",{className:h},r.default.createElement(l.HiServerStack,null),"Generate the backend"),r.default.createElement("section",{className:f},"Generate all the tedious-to-maintain parts of your backend, like routing, CORS, parsing and serialization of parameters and bodies, and just implement moving data."),r.default.createElement(s.Button,{href:d.links.doc("ServerGettingStarted")},r.default.createElement(l.HiBookOpen,null),"Learn more")),r.default.createElement("div",{className:u},r.default.createElement("h3",{className:h},r.default.createElement(l.HiWrenchScrewdriver,null),"See it in action!"),r.default.createElement("section",{className:f},"Check out the configuration editor, right here in your browser! See the generated output in real time as you edit the configuration! ",r.default.createElement("br",null),r.default.createElement("b",null,"YOUR data stays in YOUR browser!")),r.default.createElement(s.Button,{href:d.links.editor()},r.default.createElement(l.HiCog6Tooth,null),"Go to editor")))},19388:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.HeroSection=void 0;const n=o(18592),r=a(o(67294)),l=o(19446),i=o(78436),s=o(80887),c=o(69274),d=o(3930),m=o(46161),u=o(77255),h=n.css`
  label: hero-section;
  width: 100%;
...
`;t.HeroSection=()=>r.default.createElement("div",{className:h},r.default.createElement("div",{className:(0,n.cx)(m.containerStyle,f)},r.default.createElement("h2",{className:p},"Generate TypeScript from OpenAPI, that makes sense."),r.default.createElement("h3",{className:g},"Customizable, extensible and ",r.default.createElement("b",null,"open source")," code generators, that output quality"," ",r.default.createElement(d.Link,{href:"https://www.typescriptlang.org"},"TypeScript"),", from your"," ",r.default.createElement(d.Link,{href:"https://www.openapis.org"},"OpenAPI")," definitions."),r.default.createElement("div",{className:b},r.default.createElement(i.Button,{variant:"primary",href:u.links.doc("SdkGettingStarted")},r.default.createElement(c.HiPlay,null)," Get Started"),r.default.createElement(i.Button,{href:"https://github.com/oats-ts/oats-ts"},r.default.createElement(c.HiCodeBracket,null)," Github"))))},802:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.LandingPage=void 0;const n=a(o(67294)),r=o(60488),l=o(18023),i=o(51442),s=o(19388),c=o(5973),d=o(10186),m=o(90120),u=o(8015),h=o(7117),f=o(80887),p=o(26638),g=o(77255),b=()=>{const e=(0,h.useProvideMobileContext)();return n.default.createElement(h.MobileContext.Provider,{value:e},n.default.createElement(u.MobileHeaderWithOverlay,{version:!1,href:g.links.index()},n.default.createElement(p.LandingPageMenu,null)))};t.LandingPage=()=>n.default.createElement(m.AppContainer,null,n.default.createElement(c.Header,null),n.default.createElement(f.BreakPoint,{Component:b,breakpoint:"phone"}),n.default.createElement(r.Content,null,n.default.createElement(s.HeroSection,null),n.default.createElement(i.Headlines,null),n.default.createElement(d.QuickStart,null)),n.default.createElement(l.Footer,null))},26638:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.LandingPageMenu=void 0;const n=a(o(67294)),r=o(69274),l=o(16507),i=o(69585),s=o(77255);t.LandingPageMenu=()=>n.default.createElement(l.MenuBar,null,n.default.createElement(i.MenuItem,{label:"Home",icon:r.HiHome,href:s.links.index(),active:!0}),n.default.createElement(i.MenuItem,{label:"Documentation",icon:r.HiDocument,href:s.links.docs()}),n.default.createElement(i.MenuItem,{label:"Editor",icon:r.HiCog6Tooth,href:s.links.editor()}))},10186:function(e,t,o){var a=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.QuickStart=void 0;const n=o(18592),r=a(o(67294)),l=o(69274),i=o(19446),s=o(65601),c=o(44702),d=o(3930),m=a(o(43428)),u=a(o(24085)),h=o(4074),f=o(77255),p=n.css`
  label: quick-start;
