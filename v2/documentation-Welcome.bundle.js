...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,kind:n})=>{const[r,a]=(0,l.useState)(!1),[c,u]=(0,l.useState)(!1),[h,x]=(0,l.useState)(void 0),y=(0,i.cx)("editor"===n?_:b),k="editor"===n?g:p,w=(0,i.cx)(v);return l.default.createElement("div",{className:y,onMouseEnter:()=>{u(!0)},onMouseLeave:()=>{u(!1)}},l.default.createElement(s.Prism,{language:t,style:k,wrapLongLines:o,showLineNumbers:"editor"===n},e),l.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,f.isNil)(h)||(clearTimeout(h),x(void 0)),a(t),x(setTimeout((()=>{a(!1)}),2e3))}},l.default.createElement("button",{className:w,style:{opacity:c?1:0}},r?l.default.createElement(m.HiCheck,null):l.default.createElement(m.HiClipboard,null))))}},89937:function(e,t,o){var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const r=o(18592),a=n(o(67294)),i=o(61329),l=r.css`
