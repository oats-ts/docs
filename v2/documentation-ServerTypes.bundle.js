...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,kind:r})=>{const[n,a]=(0,i.useState)(!1),[c,u]=(0,i.useState)(!1),[h,k]=(0,i.useState)(void 0),x=(0,s.cx)("editor"===r?y:b),_="editor"===r?g:f,S=(0,s.cx)(v);return i.default.createElement("div",{className:x,onMouseEnter:()=>{u(!0)},onMouseLeave:()=>{u(!1)}},i.default.createElement(l.Prism,{language:t,style:_,wrapLongLines:o,showLineNumbers:"editor"===r},e),i.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,p.isNil)(h)||(clearTimeout(h),k(void 0)),a(t),k(setTimeout((()=>{a(!1)}),2e3))}},i.default.createElement("button",{className:S,style:{opacity:c?1:0}},n?i.default.createElement(m.HiCheck,null):i.default.createElement(m.HiClipboard,null))))}},89937:function(e,t,o){var r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const n=o(18592),a=r(o(67294)),s=o(61329),i=n.css`
