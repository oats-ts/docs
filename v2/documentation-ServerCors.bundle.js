...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,kind:r})=>{const[n,a]=(0,s.useState)(!1),[c,u]=(0,s.useState)(!1),[f,y]=(0,s.useState)(void 0),_=(0,i.cx)("editor"===r?x:v),w="editor"===r?g:p,k=(0,i.cx)(b);return s.default.createElement("div",{className:_,onMouseEnter:()=>{u(!0)},onMouseLeave:()=>{u(!1)}},s.default.createElement(l.Prism,{language:t,style:w,wrapLongLines:o,showLineNumbers:"editor"===r},e),s.default.createElement(d.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,h.isNil)(f)||(clearTimeout(f),y(void 0)),a(t),y(setTimeout((()=>{a(!1)}),2e3))}},s.default.createElement("button",{className:k,style:{opacity:c?1:0}},n?s.default.createElement(m.HiCheck,null):s.default.createElement(m.HiClipboard,null))))}},89937:function(e,t,o){var r=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.TBody=t.THead=t.Td=t.Th=t.Tr=t.Table=void 0;const n=o(18592),a=r(o(67294)),i=o(61329),s=n.css`
