...
`;t.SyntaxHighlighter=({children:e,language:t,lineWrap:o,theme:n,host:a,renderer:r})=>{const[i,d]=(0,s.useState)(!1),[f,k]=(0,s.useState)(void 0),_="editor"===a?x:v;return s.default.createElement("div",{className:_},s.default.createElement(c.Prism,{language:t,style:g[n],wrapLongLines:o,showLineNumbers:"editor"===a,...(0,p.isNil)(r)?{}:{renderer:r}},e),s.default.createElement(u.CopyToClipboard,{text:e,onCopy:(e,t)=>{(0,p.isNil)(f)||(clearTimeout(f),k(void 0)),d(t),k(setTimeout((()=>{d(!1)}),2e3))}},s.default.createElement("button",{className:(y=b[n],l.css`
...
`,u=a.css`
  margin-left: 0.6rem;
`,m=({isOpen:e,isEmpty:t})=>t?r.default.createElement(i.HiChevronLeft,null):e?r.default.createElement(i.HiChevronDown,null):r.default.createElement(i.HiChevronRight,null);t.TreeNode=function e({value:t,level:o,getLabel:n,isActive:i=(()=>!1),isOpen:l=(()=>!1),isContainer:h=(()=>!1),getChildren:p=(()=>[]),onClick:f=(()=>{}),getHref:g=(()=>{}),getIcon:b=(()=>{})}){const v=p(t),x=l(t),k=i(t),_=h(t),y=b(t),w=_&&x?(0,a.cx)(s,(e=>a.css`
  &::before {
    z-index: 5;
